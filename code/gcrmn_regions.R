...
data_gcrmn_regions <- data_gcrmn_regions %>% 
  mutate(subregion_name = case_when(region == "Australia" & subregion == 1 ~ "Cocos Keeling and Christmas Island",
                                    ...
                                    region == "ETP" & subregion == 2 ~ "Mesoamerican Pacific",
                                    region == "ETP" & subregion == 3 ~ "Panama Bight / Guayaquil",
                                    region == "ETP" & subregion == 4 ~ "Galapagos and Cocos",
                                    region == "ETP" & subregion == 5 ~ "Revillagigedo and Clipperton",
